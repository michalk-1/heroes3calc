...
def create_app(test_config=None):
    ...
    def banks_list():
        return jsonify({'banks': os.listdir(os.path.join(app.root_path, 'data/images/banks'))})

    @app.route('/images/banks/<path:path>')
    def banks(path: str):
        return send_from_directory(os.path.join(app.root_path, 'data/images/banks'), path)
